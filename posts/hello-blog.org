...
Right around that time I became really invested into the [[https://guix.gnu.org][GNU Guix]] project, and began porting my entire configuration to it, and while I was becoming more comfortable with [[https://www.gnu.org/software/guile/][GNU Guile]], the programming language used for this project, I came across [[https://dthompson.us/projects/haunt.html][Haunt]]. I was immediately hooked and became really fond of the minimalist approach it encourages, allowing you to write your entire site in Scheme.
